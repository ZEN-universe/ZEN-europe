...
class LigniteCoalPlantConfig(ConversionTechnologyConfig):
...
class LigniteCoalPlant(ConversionTechnology):
    ...
    def _set_capacity_existing(self) -> Attribute:
        ...
        if self.model.config.data.conversion_technology.lignite_coal_plant.use_entsoe_existing_capacities:

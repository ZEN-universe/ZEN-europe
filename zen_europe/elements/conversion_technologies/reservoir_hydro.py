...
class ReservoirHydroConfig(ConversionTechnologyConfig):
...
class ReservoirHydro(ConversionTechnology):
    ...
    def _set_capacity_existing(self) -> Attribute:
        ...
        if self.model.config.data.conversion_technology.reservoir_hydro.use_entsoe_existing_capacities:
    ...
    def _build_combined_limits(self, bound_type: str) -> Attribute:
        """Constructs 2025 and 2030 limits by merging ENTSO-E and TYNDP spatial indexes."""

...
import pandas as pd
from zen_creator import MetaData, ConversionTechnologyConfig, ConversionTechnology, Attribute, SourceInformation
from zen_europe.datasets.datasets import EntsoePPDataset, TYNDP2024Dataset

class NaturalGasTurbineConfig(ConversionTechnologyConfig):
...
class NaturalGasTurbine(ConversionTechnology):
    ...
    def _set_capacity_existing(self) -> Attribute:
        ...
        if self.model.config.data.conversion_technology.natural_gas_turbine.use_entsoe_existing_capacities:
